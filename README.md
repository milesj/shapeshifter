...
The plugin accepts an object with the following options -- with most of them based on the
...
```javascript
import ShapeshifterTranspilePlugin from 'shapeshifter/lib/bundlers/WebpackTranspilePlugin';
