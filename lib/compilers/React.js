...
var ReactCompiler = function (_Compiler) {
    ...
    _createClass(ReactCompiler, [{
        ...
        value: function renderEnum(field, definition) {
            ...
            return this.wrapProperty(field, definition, this.wrapFunction('oneOf', this.formatArray(values, valueType)));
        }
    }, {
        key: 'renderFunc',
        ...
        key: 'renderInstance',
        value: function renderInstance(field, definition) {
            return this.wrapProperty(field, definition, this.wrapFunction('instanceOf', this.formatValue(definition.config.contract, 'function')));
        }
    }, {
        key: 'renderNumber',
        ...
        value: function wrapProperty(field, definition, template) {
            ...
            var response = '' + (0, _indent2.default)(depth) + field + ': PropTypes.' + template;
