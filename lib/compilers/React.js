...
var ReactCompiler = function (_Compiler) {
    ...
    _createClass(ReactCompiler, [{
        ...
        value: function renderEnum(definition) {
            ...
            return this.wrapProperty(definition, this.wrapFunction('oneOf', this.formatArray(values, valueType)));
        }
    }, {
        key: 'renderFunc',
        ...
        value: function renderInstance(definition) {
            ...
            return this.wrapProperty(definition, this.wrapFunction('instanceOf', this.formatValue(contract, 'function')));
        }
    }, {
        key: 'renderNumber',
        ...
        key: 'wrapProperty',
        value: function wrapProperty(definition, template) {
            var depth = arguments.length <= 2 || arguments[2] === undefined ? 1 : arguments[2];

            var response = '' + (0, _indent2.default)(depth) + definition.field + ': PropTypes.' + template;
