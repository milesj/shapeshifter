...
var ReactCompiler = function (_Compiler) {
    ...
    _createClass(ReactCompiler, [{
        ...
        value: function compile() {
            ...
            return 'const ' + this.getResourceName() + ' = ' + this.renderShape({ fields: fields }) + ';';
        }
    }, {
        key: 'renderArray',
        ...
        value: function renderObject(definition) {
            return this.wrapPropType(definition, this.wrapFunction('objectOf', this.compileField(definition.valueType)));
        }
    }, {
        key: 'renderShape',
        value: function renderShape(definition) {
            ...
            return this.wrapPropType(definition, this.wrapFunction('shape', this.formatObject(this.compileProperties(definition.fields, depth + 1), depth)));
        }
    }, {
        key: 'renderString',
