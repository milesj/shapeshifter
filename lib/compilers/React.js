...
var ReactCompiler = function (_Compiler) {
    ...
    _createClass(ReactCompiler, [{
        ...
        value: function compile() {
            ...
            return 'const ' + this.getResourceName() + ' = ' + this.renderShape({ attributes: attributes }) + ';';
        }
    }, {
        key: 'renderArray',
        ...
        value: function renderEnum(definition) {
            ...
            return this.wrapPropType(definition, this.wrapFunction('oneOf', this.formatArray(this.compileArrayItems(values, valueType, depth + 1), depth)));
        }
    }, {
        key: 'renderFunc',
