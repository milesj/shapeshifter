...
var Array = function (_Definition) {
    _inherits(Array, _Definition);

    function Array() {
        _classCallCheck(this, Array);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(Array).apply(this, arguments));
    }

    _createClass(Array, [{
        key: 'validateConfig',
        value: function validateConfig() {
            _get(Object.getPrototypeOf(Array.prototype), 'validateConfig', this).call(this);
