...
var ObjectDefinition = function (_Definition) {
   ...
   * {@inheritDoc}
   */
  function ObjectDefinition(attribute, config) {
    _classCallCheck(this, ObjectDefinition);

    return _possibleConstructorReturn(this, (ObjectDefinition.__proto__ || Object.getPrototypeOf(ObjectDefinition)).call(this, attribute, _extends({
      keyType: 'string'
    }, config)));
  }
  ...
  _createClass(ObjectDefinition, [{
    ...
    value: function validateConfig() {
      ...
      this.keyType = _Factory2.default.definition(this.attribute + '_key', keyType);
      this.valueType = _Factory2.default.definition(this.attribute + '_value', valueType);
    }
  }]);
