...
var InstanceDefinition = function (_Definition) {
    ...
    function InstanceDefinition() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(InstanceDefinition).apply(this, arguments));
    }

    _createClass(InstanceDefinition, [{
        key: 'validateConfig',
        value: function validateConfig() {
            _get(Object.getPrototypeOf(InstanceDefinition.prototype), 'validateConfig', this).call(this);

            var contract = this.config.contract;


            if (!contract) {
                throw new SyntaxError('Instance definitions require a "contract" property, ' + 'which is the function or class name to evaluate against.');
...
exports.default = InstanceDefinition;