...
var ReferenceDefinition = function (_Definition) {
  ...
  function ReferenceDefinition() {
    ...
    return _possibleConstructorReturn(this, (ReferenceDefinition.__proto__ || Object.getPrototypeOf(ReferenceDefinition)).apply(this, arguments));
  }
  ...
  _createClass(ReferenceDefinition, [{
    ...
    value: function validateConfig() {
      ...
      if (!reference && !self) {
        throw new SyntaxError('Reference definitions require a "reference" property, ' + 'which points to an external schema to use, ' + 'or a "self" property, which uses the current schema.');
