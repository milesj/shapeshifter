  ...
  _createClass(Renderer, [{
    ...
    value: function getImports() {
      ...
      this.schema.imports.forEach(function (importStatement) {
        response.push(_this.renderImport(importStatement));
      });
    ...
    value: function renderArrayItems(items) {
      ...
      return items.map(function (item) {
        return (0, _indent2.default)(depth) + _this2.wrapItem(_this2.renderOrFormat(item, depth, valueType));
      });
    }
    ...
    value: function renderObjectProps(props) {
      ...
      return props.map(function (prop) {
        return (0, _indent2.default)(depth) + _this3.wrapProperty(prop.attribute, _this3.renderOrFormat(prop, depth));
      });
    }
