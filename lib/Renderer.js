...
var Renderer = function () {
  function Renderer(options, schema) {
  ...
  _createClass(Renderer, [{
    ...
    value: function formatArray(items, depth) {
      ...
      return '[' + indentSpacer + items + indentSpacer + (0, _indent2.default)(depth, this.options.indentCharacter) + ']';
    }
    ...
    value: function formatObject(props, depth) {
      ...
      return '{' + indentSpacer + props + indentSpacer + (0, _indent2.default)(depth, this.options.indentCharacter) + '}';
    }
    ...
    value: function getObjectName() {
      ...
      return [].concat(names, [this.suffix]).map(_formatName2.default).join('');
    }
    ...
    value: function parseSets() {
      ...
      Object.keys(subsets).forEach(function (setName) {
        ...
        _this4.sets.push(_this4.render(_this4.getObjectName(name, setName), setAttributes));
      });
    ...
    value: function wrapItem(value) {
      ...
      return '' + (0, _indent2.default)(depth, this.options.indentCharacter) + value + ',';
    }
    ...
    value: function wrapProperty(key, value) {
      ...
      return '' + (0, _indent2.default)(depth, this.options.indentCharacter) + key + ': ' + value + (sep || ',');
    }
