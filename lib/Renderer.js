...
var Renderer = function () {
  ...
  _createClass(Renderer, [{
    ...
    value: function getSchemaName() {
      ...
      return [this.schema.name, setName, _config2.default.schemaSuffix].map(function (value) {
        if (!value) {
          return '';
        }
    ...
    value: function getSets() {
      ...
      Object.keys(subsets).forEach(function (setName) {
        ...
        response.push(_this3.render(setName, setAttributes));
      });
    ...
    value: function renderArrayItems(items) {
      ...
      return items.map(function (item) {
        return (0, _indent2.default)(depth) + _this4.wrapItem(_this4.renderOrFormat(item, depth, valueType));
      });
    }
    ...
    value: function renderObjectProps(props) {
      ...
      return props.map(function (prop) {
        return (0, _indent2.default)(depth) + _this6.wrapProperty(prop.attribute, _this6.renderAttribute(prop, depth));
      });
    }
