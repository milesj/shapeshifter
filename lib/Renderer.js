...
var Renderer = function () {
  ...
  _createClass(Renderer, [{
    ...
    key: 'formatName',
    value: function formatName(value) {
      if (!value) {
        return '';
      }
    ...
    value: function getSchemaName() {
      ...
      return [this.schema.name, setName, _config2.default.schemaSuffix].map(this.formatName).join('');
    }
    ...
    value: function parseSets() {
      ...
      Object.keys(subsets).forEach(function (setName) {
        ...
        _this3.sets.push(_this3.render(setName, setAttributes));
      });
    }
    ...
    value: function renderArrayItems(items) {
      ...
      return items.map(function (item) {
        return _this4.wrapItem(_this4.renderOrFormat(item, depth, valueType), depth);
      });
    }
    ...
    value: function renderObjectProps(props) {
      ...
      return props.map(function (prop) {
        return _this6.wrapProperty(_this6.wrapPropertyName(prop), _this6.renderAttribute(prop, depth), depth, sep);
      });
    }
