...
function Schema(data) {
  ...
  } else if (schema.hasOwnProperty('constants') && !(0, _isObject2.default)(schema.constants)) {
    throw new SyntaxError('Schema constants must be an object that maps to primitive values.');
  } else if (schema.hasOwnProperty('subsets') && !(0, _isObject2.default)(schema.subsets)) {
    throw new SyntaxError('Schema subsets must be an object.');
  } else if (schema.hasOwnProperty('references') && !(0, _isObject2.default)(schema.references)) {
