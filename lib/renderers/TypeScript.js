...
var TypeScriptRenderer = function (_Renderer) {
  ...
  function TypeScriptRenderer() {
    ...
    return _possibleConstructorReturn(this, (TypeScriptRenderer.__proto__ || Object.getPrototypeOf(TypeScriptRenderer)).apply(this, arguments));
  }
  ...
  _createClass(TypeScriptRenderer, [{
    ...
    value: function render(setName) {
      ...
      return 'export interface ' + this.getObjectName(setName) + ' ' + this.renderShape({ attributes: attributes }, 0);
    }
