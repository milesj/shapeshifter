...
var TypeScriptRenderer = function (_Renderer) {
  ...
  function TypeScriptRenderer(options, schema) {
    _classCallCheck(this, TypeScriptRenderer);

    var _this = _possibleConstructorReturn(this, (TypeScriptRenderer.__proto__ || Object.getPrototypeOf(TypeScriptRenderer)).call(this, options, schema));

    _this.suffix = 'Interface';
    return _this;
  }
  ...
  _createClass(TypeScriptRenderer, [{
    ...
    value: function render(setName) {
      ...
      return 'export interface ' + setName + ' ' + this.renderShape({ attributes: attributes }, 0);
    }
      ...
      switch ((0, _normalizeType2.default)(valueType)) {
        ...
        case 'string':
          values.forEach(function (value) {
            members.push('' + (0, _indent2.default)(1, char) + value + ' = ' + currentIndex);
            currentIndex++;
          });
          break;
