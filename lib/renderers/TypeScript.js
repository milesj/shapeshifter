...
var TypeScriptRenderer = function (_Renderer) {
  ...
  function TypeScriptRenderer(schema) {
    _classCallCheck(this, TypeScriptRenderer);

    var _this = _possibleConstructorReturn(this, (TypeScriptRenderer.__proto__ || Object.getPrototypeOf(TypeScriptRenderer)).call(this, schema));
