...
var ReactRenderer = function (_Renderer) {
  ...
  _createClass(ReactRenderer, [{
    ...
    value: function render() {
      ...
      return 'export const ' + this.getSchemaName() + ' = ' + this.renderShape({ attributes: attributes }) + ';';
    }
    ...
    value: function renderArray(definition) {
      return this.wrapPropType(definition, this.wrapFunction('arrayOf', this.renderAttribute(definition.valueType)));
    }
    ...
    value: function renderObject(definition) {
      return this.wrapPropType(definition, this.wrapFunction('objectOf', this.renderAttribute(definition.valueType)));
    }
