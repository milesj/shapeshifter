...
var ReactRenderer = function (_Renderer) {
  ...
  function ReactRenderer(options, schema) {
    _classCallCheck(this, ReactRenderer);

    var _this = _possibleConstructorReturn(this, (ReactRenderer.__proto__ || Object.getPrototypeOf(ReactRenderer)).call(this, options, schema));
  ...
  _createClass(ReactRenderer, [{
    ...
    value: function render(setName) {
      ...
      return 'export const ' + setName + ' = ' + this.renderShape({ attributes: attributes }, 0) + ';';
    }
