...
var FlowRenderer = function (_Renderer) {
  ...
  function FlowRenderer(options, schema) {
    _classCallCheck(this, FlowRenderer);

    var _this = _possibleConstructorReturn(this, (FlowRenderer.__proto__ || Object.getPrototypeOf(FlowRenderer)).call(this, options, schema));
  ...
  _createClass(FlowRenderer, [{
    ...
    value: function render(setName) {
      ...
      return 'export type ' + setName + ' = ' + this.renderShape({ attributes: attributes }, 0) + ';';
    }
