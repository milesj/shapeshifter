...
var Factory = function () {
    ...
    _createClass(Factory, null, [{
        key: 'definition',
        value: function definition(field, config) {
            ...
            switch (config.type) {
                case 'array':
                    return new _Array2.default(field, config);
                case 'boolean':
                    return new _Bool2.default(field, config);
                case 'enum':
                    return new _Enum2.default(field, config);
                case 'function':
                    return new _Func2.default(field, config);
                case 'instance':
                    return new _Instance2.default(field, config);
                case 'number':
                    return new _Number2.default(field, config);
                case 'object':
                    return new _Object2.default(field, config);
                case 'shape':
                    return new _Shape2.default(field, config);
                case 'string':
                    return new _String2.default(field, config);
            }
        }
    }]);
