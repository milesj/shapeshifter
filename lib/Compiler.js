...
var Compiler = function () {
    ...
    _createClass(Compiler, [{
        ...
        value: function compileArrayItems(items) {
            var _this = this;
            ...
            return items.map(function (item) {
                return (0, _indent2.default)(depth) + _this.wrapItem(_this.compileOrFormat(item, depth, valueType));
            });
        }
    }, {
        key: 'compileObjectProps',
        value: function compileObjectProps(props) {
            var _this2 = this;

            var depth = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];

            return props.map(function (prop) {
                return (0, _indent2.default)(depth) + _this2.wrapProperty(prop.attribute, _this2.compileOrFormat(prop, depth));
            });
        }
    }, {
        key: 'compileOrFormat',
        value: function compileOrFormat(value, depth, valueType) {
            return value instanceof _Definition2.default ? this.compileAttribute(value, depth) : this.formatValue(value, valueType);
        }
    }, {
        key: 'formatArray',
        ...
        value: function getSchemaName() {
            ...
            return this.schema.name + format + _config2.default.schemaSuffix;
        }
    }, {
        key: 'wrapFunction',
