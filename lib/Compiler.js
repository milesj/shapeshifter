...
var Compiler = function () {
    ...
    _createClass(Compiler, [{
        ...
        key: 'compileProperties',
        value: function compileProperties(fields) {
            var _this = this;

            var depth = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];

            return fields.map(function (definition) {
                return _this.wrapProperty(definition.field, _this.compileField(definition, depth), depth);
            });
        }
    }, {
        key: 'formatArray',
        ...
        key: 'formatObject',
        value: function formatObject(properties, depth) {
