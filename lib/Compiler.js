...
var Compiler = function () {
  ...
  _createClass(Compiler, [{
    key: 'format',
    value: function format(value, type) {
    ...
    key: 'render',
    value: function render(definition) {
    ...
    value: function renderOrFormat(value, depth, valueType) {
      return value instanceof _Definition2.default ? this.render(value, depth) : this.format(value, valueType);
    }
